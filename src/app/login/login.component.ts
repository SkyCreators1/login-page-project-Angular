...
@Component({
  ...
  <div class="mt-10 sm:mx-auto px-6 py-12 rounded-3xl  bg-neutral-300	 sm:w-full sm:max-w-sm">
  ...
  <div>
    <img class="mx-auto h-30 w-auto" src="https://skycreators.it/cdn/shop/files/creazione-gif-davide.gif?v=1679688394&width=310" alt="Your Company">
  </div>
</div>
